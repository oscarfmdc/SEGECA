...
public class ConectorBD {
	...
	public void deleteCCC(String ccc){
		try {
			statement.executeUpdate("delete from `CCC` where `nombre_CCC`='"+ ccc +"' limit 1");
		} catch (SQLException e) {
			System.out.println("Error al intentar eliminar el CCC: " + ccc);
		}
	}
